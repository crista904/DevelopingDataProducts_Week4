...
1. First the user needs to input their height.  
2. Then the user needs to input their weight.  
3. This will give them a BMI calculation.
4. See the intersect between the red and blue line and compare yourself to the average (open dot) American women height and weight.
